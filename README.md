...
gitCards 最初是 [daidr](https://daidr.me/) 为 WordPress 编写的插件。

本项目将其转写为 Typecho 插件，适配 **Typecho 1.3.0** 和 **PHP 8.4**。
...
```
[gitcard type="1"]https://github.com/songshuxiao/GitCards[/gitcard]
```
